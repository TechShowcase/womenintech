...
1. Search [WomenInTech](https://github.com/TechShowcase/womenintech/pulls) for an open or closed PR that relates to your submission.
...
3. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the `womenintech` repo.
...
10. In GitHub, send a pull request to `TechShowcase/womenintech:main`.
...
If the issue you are working on is an approved request for adding a new profile to be featured in WomenInTech, follow these steps:
